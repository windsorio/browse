...
semantics.addAttribute('asLisp', {
  ...
  AndExpr_and:    function(l, _, r)        { return ["&&", l.asLisp, r.asLisp]; },
  OrExpr_or:      function(l, _, r)        { return ["||", l.asLisp, r.asLisp]; },

  ruleName:       function (m, _, n)       { return m.asLisp + ":" + n.asLisp; },
...
semantics.addOperation('interpret()', {
  ...
  AndExpr_and:     function(l, _, r)         { return  l.interpret() && r.interpret(); },
  OrExpr_or:     function(l, _, r)         { return  l.interpret() || r.interpret(); },
